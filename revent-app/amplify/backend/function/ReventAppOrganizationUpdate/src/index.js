...
/***/ "./tsc-src/core/common/create-item.ts":
/*!********************************************!*\
  !*** ./tsc-src/core/common/create-item.ts ***!
  \********************************************/
/***/ (function(__unused_webpack_module, exports, __webpack_require__) {

eval("\nvar __awaiter = (this && this.__awaiter) || function (thisArg, _arguments, P, generator) {\n    function adopt(value) { return value instanceof P ? value : new P(function (resolve) { resolve(value); }); }\n    return new (P || (P = Promise))(function (resolve, reject) {\n        function fulfilled(value) { try { step(generator.next(value)); } catch (e) { reject(e); } }\n        function rejected(value) { try { step(generator[\"throw\"](value)); } catch (e) { reject(e); } }\n        function step(result) { result.done ? resolve(result.value) : adopt(result.value).then(fulfilled, rejected); }\n        step((generator = generator.apply(thisArg, _arguments || [])).next());\n    });\n};\nObject.defineProperty(exports, \"__esModule\", ({ value: true }));\nexports.BaseCreateItemImpl = void 0;\nconst uuid_1 = __webpack_require__(/*! uuid */ \"./node_modules/uuid/dist/index.js\");\nconst error_type_1 = __webpack_require__(/*! ../constant/error-type */ \"./tsc-src/core/constant/error-type.ts\");\nconst message_1 = __webpack_require__(/*! ../constant/message */ \"./tsc-src/core/constant/message.ts\");\nconst is_empty_1 = __webpack_require__(/*! ../helpers/is-empty */ \"./tsc-src/core/helpers/is-empty.ts\");\nconst ddb_doc_client_1 = __webpack_require__(/*! ./ddb-doc-client */ \"./tsc-src/core/common/ddb-doc-client.ts\");\nconst error_1 = __webpack_require__(/*! ./error */ \"./tsc-src/core/common/error.ts\");\nconst validator_1 = __webpack_require__(/*! ./validator */ \"./tsc-src/core/common/validator.ts\");\nclass BaseCreateItemImpl {\n    static of(props) {\n        return {\n            execute: () => __awaiter(this, void 0, void 0, function* () {\n                const { tableName, typeName, item, validationRules, customValidator } = props;\n                // Validate model if any\n                if (validationRules) {\n                    const validationError = new validator_1.Validator().validate(item, validationRules);\n                    if (!(0, is_empty_1.isEmpty)(validationError)) {\n                        throw new error_1.LambdaResolverError(error_type_1.LambdaResolverErrorType.BadRequest, message_1.Message.BadRequestError);\n                    }\n                }\n                // Do custom validation if any\n                yield (customValidator === null || customValidator === void 0 ? void 0 : customValidator(item));\n                // Finished validation, proceed save to database\n                const date = new Date();\n                const id = (0, uuid_1.v4)();\n                const createItemInput = Object.assign(Object.assign({}, item), { id, createdAt: date.toISOString(), updatedAt: date.toISOString() });\n                try {\n                    yield ddb_doc_client_1.ddbDocClient.put({\n                        TableName: tableName,\n                        Item: Object.assign(Object.assign({}, createItemInput), { '__typename': typeName }),\n                    }).promise();\n                    const getItemOutput = yield ddb_doc_client_1.ddbDocClient.get({\n                        TableName: tableName,\n                        Key: {\n                            id,\n                        },\n                    }).promise();\n                    return getItemOutput.Item;\n                }\n                catch (error) {\n                    throw new error_1.LambdaResolverError(error_type_1.LambdaResolverErrorType.InternalServerError, message_1.Message.InternalServerError);\n                }\n            }),\n        };\n    }\n}\nexports.BaseCreateItemImpl = BaseCreateItemImpl;\n\n\n//# sourceURL=webpack:///./tsc-src/core/common/create-item.ts?");
...
/***/ "./tsc-src/core/common/handle-error.ts":
/*!*********************************************!*\
  !*** ./tsc-src/core/common/handle-error.ts ***!
  \*********************************************/
/***/ ((__unused_webpack_module, exports, __webpack_require__) => {

eval("\nObject.defineProperty(exports, \"__esModule\", ({ value: true }));\nexports.handleError = void 0;\nconst error_code_1 = __webpack_require__(/*! ../constant/error-code */ \"./tsc-src/core/constant/error-code.ts\");\nconst error_type_1 = __webpack_require__(/*! ../constant/error-type */ \"./tsc-src/core/constant/error-type.ts\");\nconst message_1 = __webpack_require__(/*! ../constant/message */ \"./tsc-src/core/constant/message.ts\");\nconst error_1 = __webpack_require__(/*! ./error */ \"./tsc-src/core/common/error.ts\");\nfunction handleError(error) {\n    if (error.code === error_code_1.LambdaResolverErrorCode.ConditionalCheckFailed) {\n        throw new error_1.LambdaResolverError(error_type_1.LambdaResolverErrorType.ConditionalCheckFailed, message_1.Message.ConditionalCheckFailed);\n    }\n    throw new error_1.LambdaResolverError(error_type_1.LambdaResolverErrorType.InternalServerError, message_1.Message.InternalServerError);\n}\nexports.handleError = handleError;\n\n\n//# sourceURL=webpack:///./tsc-src/core/common/handle-error.ts?");

/***/ }),

/***/ "./tsc-src/core/common/update-expression.ts":
/*!**************************************************!*\
  !*** ./tsc-src/core/common/update-expression.ts ***!
  \**************************************************/
/***/ ((__unused_webpack_module, exports) => {

eval("\nObject.defineProperty(exports, \"__esModule\", ({ value: true }));\nexports.getUpdateExpression = void 0;\nfunction getUpdateExpression(input) {\n    const updateItem = Object.assign(Object.assign({}, input), { updatedAt: new Date().toISOString() });\n    const expressionAttributes = {};\n    const expressionAttributeValues = {};\n    const keys = Object.keys(updateItem);\n    const updateExpressionsMap = keys.map((key) => {\n        expressionAttributes[`#${key}`] = key;\n        expressionAttributeValues[`:${key}`] = updateItem[key];\n        return `#${key} = :${key}`;\n    });\n    const updateExpression = `SET ${updateExpressionsMap.join(',')}`;\n    return {\n        UpdateExpression: updateExpression,\n        ExpressionAttributeNames: expressionAttributes,\n        ExpressionAttributeValues: expressionAttributeValues,\n    };\n}\nexports.getUpdateExpression = getUpdateExpression;\n\n\n//# sourceURL=webpack:///./tsc-src/core/common/update-expression.ts?");

/***/ }),

/***/ "./tsc-src/core/common/validator.ts":
/*!******************************************!*\
  !*** ./tsc-src/core/common/validator.ts ***!
  \******************************************/
/***/ ((__unused_webpack_module, exports) => {

eval("\nObject.defineProperty(exports, \"__esModule\", ({ value: true }));\nexports.Validator = exports.ValidationRules = void 0;\nvar ValidationRules;\n(function (ValidationRules) {\n    ValidationRules[ValidationRules[\"REQUIRED\"] = 0] = \"REQUIRED\";\n    ValidationRules[ValidationRules[\"DATE_TIME\"] = 1] = \"DATE_TIME\";\n    ValidationRules[ValidationRules[\"EMAIL\"] = 2] = \"EMAIL\";\n})(ValidationRules = exports.ValidationRules || (exports.ValidationRules = {}));\n;\nclass Validator {\n    /**\n     * Validate the json data by rules config\n     * @param data: Json object to validate\n     * @param rules: Rules object which keys match to fields in json object, and value is its validation rules\n     * @returns: Error object which keys are fields, and value is error validation message\n     */\n    validate(data, rules) {\n        const errors = {};\n        Object.entries(data).forEach(([key, value]) => {\n            const rule = rules[key];\n            const error = rule && this.validateValue(value, rule);\n            if (!error)\n                return;\n            errors[key] = error;\n        });\n        return errors;\n    }\n    validateValue(value, rules) {\n        const trimValue = value && value.trim ? value.trim() : value;\n        let error = null;\n        if (rules) {\n            const ruleCount = rules.length;\n            for (let i = 0; i < ruleCount; i++) {\n                const rule = rules[i];\n                const validator = this.getValidator(rule);\n                if (!validator)\n                    continue;\n                error = validator(trimValue);\n                if (error) {\n                    break;\n                }\n            }\n        }\n        return error;\n    }\n    /**\n     * Return validator by rule name\n     */\n    getValidator(rule) {\n        const validatorByRule = {\n            [ValidationRules.REQUIRED]: this.validateRequired.bind(this),\n            [ValidationRules.DATE_TIME]: this.validateDate.bind(this),\n            [ValidationRules.EMAIL]: this.validateEmail.bind(this),\n        };\n        return validatorByRule[rule];\n    }\n    validateDate(value) {\n        return true;\n    }\n    validateEmail(value) {\n        return true;\n    }\n    validateRequired(value) {\n        return (value === undefined || value === null || value === '' || (value === null || value === void 0 ? void 0 : value.length) === 0);\n    }\n}\nexports.Validator = Validator;\n\n\n//# sourceURL=webpack:///./tsc-src/core/common/validator.ts?");

/***/ }),

/***/ "./tsc-src/core/constant/error-code.ts":
/*!*********************************************!*\
  !*** ./tsc-src/core/constant/error-code.ts ***!
  \*********************************************/
/***/ ((__unused_webpack_module, exports) => {

eval("\nObject.defineProperty(exports, \"__esModule\", ({ value: true }));\nexports.LambdaResolverErrorCode = void 0;\nvar LambdaResolverErrorCode;\n(function (LambdaResolverErrorCode) {\n    LambdaResolverErrorCode[\"ConditionalCheckFailed\"] = \"ConditionalCheckFailedException\";\n})(LambdaResolverErrorCode = exports.LambdaResolverErrorCode || (exports.LambdaResolverErrorCode = {}));\n\n\n//# sourceURL=webpack:///./tsc-src/core/constant/error-code.ts?");
...
/******/ 	var __webpack_exports__ = __webpack_require__("./tsc-src/function/ReventAppOrganizationUpdate/index.ts");
